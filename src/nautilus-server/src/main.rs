...
async fn main() -> Result<()> {
    ...
    #[cfg(not(any(feature = "seal-example", feature = "source-verification")))]
    ...
    // `source-verification` likewise needs no API key.
    #[cfg(any(feature = "seal-example", feature = "source-verification"))]
